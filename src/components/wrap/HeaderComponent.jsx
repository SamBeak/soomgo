      ...
      <nav className="nav-bar__container">
        <div className="nav-bar__left">
          <div className="nav-bar__img">
            <Link to="/home"><img src="http://localhost:3000/images/header/icon-navi-logo.svg" alt="숨고 로고" /></Link>
          </div>
        ...
        <div className="nav-bar__center">
          <form action="" className={state.isSearch ? 'nav-bar__search on' : 'nav-bar__search'}>
            <div className="nav-bar__icon">
              <img src="http://localhost:3000/images/header/icon-navi-search.svg" alt="검색 아이콘" />
            </div>
            ...
            <div className={state.isSearch ? 'nav-bar__btn' : 'nav-bar__btn hide'}>
              <img src="http://localhost:3000/images/header/icon-navi-close.svg" alt="닫기 버튼" onClick={onClickDeleteSearchMsg}/>
            </div>
          </form>
